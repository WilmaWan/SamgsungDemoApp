...
import wan.wilma.samsungdemoapp.SimpleLog;
...
public final class CameraManager {
  ...
  private final camera.CameraConfigurationManager configManager;
  ...
  public CameraManager(Context context) {
    ...
    this.configManager = new camera.CameraConfigurationManager(context);
  }
